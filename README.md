...
Generative art refers to art that in whole or in part has been created with the use of autonomous systems. Classic systems can be summed up as a brain and its input/output. For a system that generate art, it means that first the system needs to be fed some information and rules governing the evolution of this input. Last, it has to represent what has been generated. Very often, it relies on repetition, geometric transformations or randomness. But you can feed it any kind of value from simple noise to complex data or your own formalized systems.
